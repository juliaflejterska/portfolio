...
let nativeFunctions, dirName = path$1.dirname(url.fileURLToPath((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('index.cjs', document.baseURI).href)))).replace(/dist$/, '');
try {
	nativeFunctions = require$1('node-gyp-build')(dirName);
...
var nodeIndex = {
	open, getLastVersion, compareKey: index_js.compareKeys, keyValueToBuffer: index_js.toBufferKey, bufferToKeyValue: index_js.fromBufferKey, path: path__default["default"], EventEmitter: EventEmitter__default["default"]
};

Object.defineProperty(exports, 'bufferToKeyValue', {
    enumerable: true,
    get: function () { return index_js.fromBufferKey; }
});
Object.defineProperty(exports, 'compareKey', {
    enumerable: true,
    get: function () { return index_js.compareKeys; }
});
...
Object.defineProperty(exports, 'keyValueToBuffer', {
    enumerable: true,
    get: function () { return index_js.toBufferKey; }
});
exports.ABORT = ABORT;
